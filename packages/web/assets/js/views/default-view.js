...
import { makeRequestRow, togglePromptExpand, renderRequests, appendRequests } from '../renderers.js';
...
import { fetchRequests, setReqFilter, getReqFilter, getActiveRange } from '../api.js';
  ...
  if (r.id) {
    ...
    if (existing) {
      ...
      if (r.event_phase === 'updated') {
        ...
        setTimeout(() => existing.classList.remove('row-flash-update'), 600);
      }
