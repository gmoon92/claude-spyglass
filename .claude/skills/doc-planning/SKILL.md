...
이 스킬은 프로젝트의 계획 문서를 일관된 형식으로 작성하고 관리합니다.

| 문서 유형 | 파일명 | 담당 스킬 |
|-----------|--------|-----------|
| ADR | `docs/planning/03-adr.md` | doc-adr |
| Task | `docs/planning/04-tasks-ai.md` | doc-tasks |
| Spec | `docs/planning/05-spec.md` | doc-spec |
...
├── 02-prd.md           # PRD (수동 관리)
├── 03-adr.md           # ADR (doc-adr 스킬 관리)
├── 04-tasks-ai.md      # Task (doc-tasks 스킬 관리)
└── 05-spec.md          # Spec (doc-spec 스킬 관리)
