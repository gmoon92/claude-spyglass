...
## 최종 현행화: 2026-04-26 (header-summary-merge Phase 5) — Cleanup & Consolidation (ADR-008)
...
| 오류율 / 평균 / P95 | `.timeline-meta` | `.timeline-meta .timeline-meta-group` (지난 30분) |
| 세션 / 요청 / 토큰 | `.cps-volume` (cache-panel) | **`.timeline-meta .timeline-meta-group` (오늘)** |
...
- `timeline-meta-group-label { font-size: var(--font-micro); color: var(--text-dim); text-transform: uppercase; letter-spacing: 0.5px; font-weight: var(--weight-strong); flex-shrink: 0 }` — 시간 컨텍스트 라벨 ("지난 30분" / "오늘")
